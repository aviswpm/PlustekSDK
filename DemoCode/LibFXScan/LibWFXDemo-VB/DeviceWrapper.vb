    ...
    Public Sub New()
		...
		If hLibModule = IntPtr.Zero Or hCommandModule = IntPtr.Zero Then
            ...
            If Environment.Is64BitOperatingSystem And Environment.Is64BitProcess = False Then
                keyNameLib = "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{02232A38-5FF5-47F3-A3C9-268F4588BEE8}_is1"
            Else
                keyNameLib = "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{02232A38-5FF5-47F3-A3C9-268F4588BEE8}_is1"
            End If

            If Environment.Is64BitOperatingSystem And Environment.Is64BitProcess = False Then
                keyNameSDK = "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\{E96A9957-0A5A-40C3-8358-75A3FA6D9CC7}_is1"
            Else
                keyNameSDK = "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\{E96A9957-0A5A-40C3-8358-75A3FA6D9CC7}_is1"
            End If
            ...
            If valuelib IsNot Nothing Then
                ...
                If (m_szSdkInstallPath.LastIndexOf("\") <> (m_szSdkInstallPath.Length - 1)) Then
                    m_szSdkInstallPath += "\"
                End If
